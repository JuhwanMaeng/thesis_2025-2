...
import { Edit2, Target, Sparkles } from 'lucide-react';
import type { NPC, PersonaProfile } from '@/types';
...
export function AgentPersonaPanel({ npcId }: AgentPersonaPanelProps) {
  ...
  if (!npcId || !npc) {
    return (
      <div className="w-80 h-full flex flex-col border-l border-border bg-card overflow-hidden">
            ...
            <div className="mt-2 space-y-1.5">
              ...
              {npc.current_state.goal && (
                <div className="text-sm">
                  ...
                  <span>{npc.current_state.goal}</span>
                </div>
              )}
